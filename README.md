...
def fetch_weather():
    ...
    try:
        T = float(input("Enter Ambient Temperature (°C): "))
        P = float(input("Enter Ambient Pressure (Pa): "))
...
def run():
    ...
    print("Omega1 in", omega_in)
    print("Omega2 in", omega_out)
